...
# NOTE for Resnet, the preprocessing is different that for inception
...
def generator(file_list, batch_size):
	...
	while True:
		...
		for b in range(batch_size):
			...
			img = image.load_img(filename+'_ir.jpg', target_size=(224, 224))
