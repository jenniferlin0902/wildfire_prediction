...
from keras.layers import Input, InputLayer, Flatten, Dense, GlobalAveragePooling2D
...
def build_preetrained_VGG(images, params):
...
def build_preetrained_VGG_double(inputs, params):
    ...
    out = tf.contrib.layers.batch_normalization(out)
